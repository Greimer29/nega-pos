...
export const http = defineConfig({
  ...
  /**
   * Trust Railway / reverse-proxy headers (X-Forwarded-Proto) in production
   * so secure session cookies work over HTTPS.
   */
  trustProxy: app.inProduction ? () => true : undefined,

  /**
   * Redirect configuration controles the behavior of
