...
| `/reportes` | Hub de reportes. Select a la derecha: **Reporte financiero** / **Reporte de inventario**. En financiero, pills: **Flujo de caja** (`?sub=flujo`), **Estado de resultados** (`?sub=resultados`); **Situación patrimonial** reservada. Período visible; en flujo, el drawer filtra cuenta y tipos de caja. `?vista=inventario` → snapshot de inventario con el mismo botón/drawer (categoría, orden, visibilidad) |
